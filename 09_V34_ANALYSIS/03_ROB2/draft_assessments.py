...
# ── Huang 2025 ────────────────────────────────────────────────────────────
add("Huang 2025", "Time to first defecation", "Postoperative", L, H, S, H, S,
    ...
    "D5 SOME CONCERNS: registered (MR-51-24-038798) with defecation as a co-primary, but the "
    "report gives two different values for the same co-primary results (flatus 36.4+/-8.0 vs "
    "36.20+/-8.20 and 42.2+/-8.5 vs 42.72+/-8.76 in different sections), an unresolved internal "
    "numerical inconsistency.",
    "SOURCE-QC: internal numeric inconsistency between abstract/Results and p.4 text")
...
_xing_common = (
    ...
    "being individually named in a pre-specified list. The report is also internally "
    "inconsistent about its design, describing patients as 'randomly assigned in the ratio of "
    "1:1:1 into the general anesthesia group ..., TAPB group ..., and TEAS combined with TAPB "
    "group' while the Randomization section states 'an allocation ratio of 1:1:1:1' — a fourth "
    "arm is implied but never reported.")
add("Xing 2022", "Time to first flatus", "Postoperative", L, L, L, L, S,
    ...
    "1:1:1 vs 1:1:1:1 allocation inconsistency; unreported fourth arm implied")
...
add("Zheng 2025", "Time to first flatus", "Postoperative", S, S, L, S, L,
    ...
    "what was actually measured under this label is uncertain. "
    ...
    "endpoint defined as 'first stools passed' under a flatus label")
