...
window.ROB2_SOURCE_LINKS = {
  ...
  "links": {
    ...
    "1879897074::rescue_analgesia": {
      "study": "Xie 2014",
      "matched_outcome": "Rate of breakthrough pain rescue with dezocine",
      "matched_timepoint": "Study PCA period",
      "match_method": "keyword_timepoint_unique",
      "domains": {
        "1": "allocation used a 'computer generated randomization number', with no concealment mechanism (e.g. sealed envelope) confirmed in the extracted text (same study-level judgement as this study's existing rows)",
        "2": "the EA/sham intervention was delivered entirely intraoperatively while patients were under general anaesthesia (radical esophagectomy) -- the participant never perceived the intervention at any point, including postoperatively when this rescue-medication request occurs, and 'The persons who collected the data and performed the data analysis were blinded from the group and patients assignment'",
        "3": "the extracted text states exclusion criteria but no completion/attrition figures confirming how many of the 60 randomised patients were analysed",
        "4": "an intervention applied entirely under general anaesthesia cannot bias a postoperative rescue-request decision through allocation awareness, and it was recorded/analysed by blinded personnel",
        "5": "'The primary outcome was the effect of EA on postoperative pain score and the difference of opioids doses used among different groups' -- the named primary outcome is opioid dose, not the dezocine rescue rate specifically (same reasoning as this study's existing PCA-demand-count row)"
      },
      "flags": "",
      "source_pdf": "covidence_701_full_article.pdf",
      "adopted_by": "John Ryan N. Mendoza (review lead)",
    ...
    "1879896661::flatus_time": {
      "study": "Yang 2020",
      "matched_outcome": "Time to first flatus",
      "matched_timepoint": "Postoperative",
      "match_method": "keyword_timepoint_unique",
      "domains": {
        "1": "'Group allocation was concealed using a sealed envelope containing the allocation sequence generated by SPSS in a 1:1 ratio' (same study-level judgement as this study's existing rows)",
        "2": "'This study was a single-center, randomized and open-label trial' and 'Participants and the acupuncture provider were not blind to the groups because of the specificity of EA treatment'; the comparator is usual care with no sham",
        "3": "2 of 59 randomised lost (1 excluded for absence of PVB, 1 withdrew before surgery), 3.4%, with documented reasons",
        "4": "'The assessors, anesthetists, and statisticians were unaware of study-group assignments' and 'Times to first flatus and defecation measured in hours were checked regularly', which limits detection bias; but participants were unblinded and the event timing still depends in part on participant report (same reasoning as this study's existing time-to-first-defecation row, the companion endpoint reported in the same sentence of the Methods)",
        "5": "registered ChiCTR1800014461 with time to first flatus among the stated primary outcomes; however this is explicitly a feasibility study in which 'The sample size of 60 was not determined by calculation but was the total number of patients we could recruit', and the between-group efficacy comparisons are nonetheless presented as findings"
      },
      "flags": "",
    ...
    "1879896450::intraop_remi": {
      "study": "Wu 2022",
      "matched_outcome": "Cumulative remifentanil",
      "matched_timepoint": "Intraoperative",
      "match_method": "manual_source_verified",
      "domains": {
        "1": "'All patients (n = 90) were randomized using a computer-generated number', with no allocation-concealment mechanism described; baseline characteristics were similar",
        "2": "'All researchers involved in this study were blinded to these groupings' and 'The acupoint of the pTEAS device was given on patients' legs or hands that were fully covered by the materials to ensure the pTEAS device was out of sight of blinded researchers'",
        "3": "6 of 90 (6.7%) excluded, and the loss is differential — 5 from the Control arm versus 1 from pTEAS (2 massive haemorrhage, one in each arm; 1 serious postoperative complication in Control; 3 with incomplete data collection). Excluding a patient for a POSTOPERATIVE complication discards an intraoperative value that had already been measured, and no ITT or sensitivity analysis is reported",
        "4": "remifentanil was recorded from intraoperative records by a blinded team",
        "5": "registered ChiCTR1800014634 (25/01/2018) and 'The consumption of remifentanil' is named as a primary outcome; note the report cites the registry inconsistently as 'clinicaltrials.gov (chiCTR1800014634)' and declares three co-primary outcomes without multiplicity adjustment"
      },
      "flags": "differential attrition; three declared co-primaries without adjustment",
      "source_pdf": "s12871-022-01875-3.pdf",
      "adopted_by": "John Ryan N. Mendoza (review lead)",
      "adopted_date": "2026-09-08",
      "match_evidence": "Both candidates ('Cumulative remifentanil', 'Remifentanil dose index') carry the identical analysed_n (44, 40) -- same patients, two different derived measures -- so a denominator match alone can never separate them, before or after the 2026-09-10 fix to this study's outcomes.intraop_opioid cell (previously 1100/1380, n=30/30, a figure that matched neither candidate and contradicted this study's own audit.corrections note). What the fix does provide is the actual VALUE: the corrected cell now reads 1383+/-494 vs 1637+/-630 ug, which is 'Cumulative remifentanil's' own reported figure exactly (source PDF Table 2: 'Consumption of remifentanil(ug) 1637(630) 1383(494)') and is not even on the same scale as 'Remifentanil dose index' (0.114/0.084 ug/min/kg)."
    },
    ...
    "1879896309::rescue_analgesia": {
      "study": "Tu 2024",
      "matched_outcome": "Any rescue tramadol use",
      "matched_timepoint": "6–24 h",
      "match_method": "manual_source_verified",
      "domains": {
        "1": "'Patients were randomized to either the TEAS or sham TEAS group using a computer-generated random number list'; 'Allocation concealment was achieved by enclosing the assignments in sealed, opaque, sequentially numbered envelopes, which were opened only after confirming eligibility'",
        "2": "'All patients were unaware of the group to which they were assigned'; 'each patient was told that a special acupoint stimulation, which cannot be felt via human sensory perception, was used for the treatment' -- a deceptive sham designed for an imperceptible stimulation; 'Outcome assessors, data collectors, and statisticians were also blinded to the group allocation'",
        "3": "5 of 120 (4.2%) excluded under pre-specified withdrawal criteria (3 persistent coma, 1 cognitive impairment, 1 intracranial-hypertension-induced vomiting)",
        "5": "this measure is explicitly described as part of the trial's planned data collection in the Methods",
        "4": "'Another blinded observer (nurse) recorded the postoperative data' for this trial's outcomes, so neither the self-reported nor the observer-assessed component is exposed to differential awareness of allocation"
      },
      "flags": "",
      "source_pdf": "study_244_Tu_2023.pdf",
      "adopted_by": "John Ryan N. Mendoza (review lead)",
      "adopted_date": "2026-09-08",
      "match_evidence": "Both candidates ('Any rescue tramadol use', 'Cumulative rescue tramadol consumption') carry the same analysed_n (57, 58), which used to disambiguate against the dashboard's own stored denominator until that denominator was itself corrected on 2026-09-10 (it had wrongly stored 77/76 -- a figure this trial never reports anywhere -- despite this study's own audit.corrections note already recording the true 57/58, 3/6 tramadol-rescue figures). With the fix, both candidates now match the denominator equally, and the lexical tiebreak finds no distinguishing token ('incidence' is stopworded, and 'rescue tramadol' is shared by both). Settled instead by data TYPE: the corrected dashboard cell is dichotomous (events/total, RR), and only 'Any rescue tramadol use' -- a yes/no incidence measure -- is dichotomous in nature; 'Cumulative rescue tramadol consumption' is a continuous dose amount and could never have produced an events/total figure."
    },
