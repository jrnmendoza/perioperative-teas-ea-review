...
const TRANSLATIONS = {
  en: {
    ...
    primarySection: {
      ...
      teasStratum: "Primary Stratum 1: TEAS vs Sham (k=4, N=342)",
    ...
    interpretations: {
      primary24h: "Across the 7 strict primary trials (N = 676), the combined synthesis of perioperative electrical acupoint stimulation showed an estimated 24-hour postoperative opioid reduction of 9.91 mg IV morphine equivalents (95% KH CI [−20.08, +0.27] mg, p = 0.0545, tau2 = 113.91, I2 = 98.57%; 95% PI [−39.35, +19.54]). Modality-specific analyses: TEAS vs sham (k = 4, N = 342) showed MD = −14.00 mg (95% KH CI [−34.18, +6.19], p = 0.1145), and EA vs control (k = 3, N = 334) showed MD = −3.94 mg (95% KH CI [−19.77, +11.90], p = 0.397). Because the Knapp–Hartung confidence intervals include zero across all strata, evidence does not demonstrate a statistically significant 24-hour opioid-sparing effect.",
      teasStratum: "In the double-blind sham-controlled TEAS stratum (k = 4 strict trials: Chen 1998, Chen 2020, He 2026, Szmit 2021; N = 342), opioid sparing averaged 14.00 mg IV MME (Knapp–Hartung 95% CI [−34.18, +6.19], p = 0.1145, tau2 = 156.88, I2 = 98.59%). High between-study heterogeneity reflects differing surgical baseline pain and anesthesia protocols.",
  ...
  sv: {
    ...
    primarySection: {
      ...
      teasStratum: "Primärt stratum 1: TEAS mot sham (k=4, N=342)",
