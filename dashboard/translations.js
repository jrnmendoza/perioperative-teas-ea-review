...
const TRANSLATIONS = {
  en: {
    ...
    kpi: {
      ...
      primaryTitle: "Primary Efficacy Analysis • Supportive EA Evidence",
      primaryValue: "TEAS: −14.00 mg • EA: −3.94 mg",
      primarySub: "Supporting Combined Synthesis: −9.91 mg [−20.08, +0.27] (p=0.0545, k=7)",
      primaryBadge: "PRIMARY: TEAS vs sham • EA vs usual care is supportive, not a sham-controlled primary • Combined = contextual only",
    ...
    primarySection: {
      ...
      hubText: "Locked Protocol Synthesis Standard: TEAS and EA were evaluated separately for primary modality-specific inference (TEAS vs Sham: MD = −14.00 mg, p = 0.1145; EA vs Usual Care: MD = −3.94 mg, p = 0.397). A combined strict-evidence synthesis pooling both modalities (MD = −9.91 mg [−20.08, +0.27], p = 0.0545, k = 7, N = 676) is shown as a supporting contextual analysis. Between-study variance is estimated using restricted maximum likelihood (REML) with Knapp–Hartung confidence intervals and 95% prediction intervals [−39.35, +19.54].",
      section2ATitle: "Section 2A: PRIMARY OPIOID OUTCOME — Cumulative 0–24h Opioid Sparing (Strict Modality Primary: TEAS k=4, EA k=3; Combined k=7)",
      ...
      section2BSub: "Executed in StataNow 19.5 BE via meta summarize, random(reml) se(kh) predinterval.",
      section2CTitle: "EXPLORATORY EXTENDED POSTOPERATIVE OPIOID OUTCOME — Cumulative 0–72h Opioid Sparing (Target B: k = 1 strict, k = 2 broader)",
      section2CSub: "Executed in StataNow 19.5 BE. Evaluated as hypothesis-generating extended durability.",
      trajectoryDisclaimer: "Different sets of trials contribute to each cumulative time window. These estimates should therefore not be interpreted as repeated longitudinal measurements of the same study population or as a continuous trajectory of treatment effect.",
      combinedPool: "Supporting Combined Synthesis (k=7, N=676)",
      teasStratum: "Primary Stratum 1: TEAS vs Sham (k=4, N=337)",
      eaStratum: "Primary Stratum 2: EA vs Usual Care (k=3, N=339)",
      threshold10mgNotice: "Primary prespecified clinical-importance benchmark: 10 mg IV MME. The pooled average (−9.91 mg, 95% KH CI [−20.08, +0.27]) does not reach that benchmark as a point estimate, and does not reach statistical significance, though individual high-demand surgical cohorts achieve substantial sparing.",
    ...
    metaregStudio: {
      ...
      tableTitle: "Comprehensive Moderator & Clinical Parameter Matrix (k = 7 Strict Primary RCTs)",
    ...
    interpretations: {
      primary24h: "Across the 7 strict primary trials (N = 676), the combined synthesis of perioperative electrical acupoint stimulation showed an estimated 24-hour postoperative opioid reduction of 9.91 mg IV morphine equivalents (95% KH CI [−20.08, +0.27] mg, p = 0.0545, tau2 = 113.91, I2 = 98.57%; 95% PI [−39.35, +19.54]). Modality-specific analyses: TEAS vs sham (k = 4, N = 337) showed MD = −14.00 mg (95% KH CI [−34.18, +6.19], p = 0.1145), and EA vs control (k = 3, N = 339) showed MD = −3.94 mg (95% KH CI [−19.77, +11.90], p = 0.397). Because the Knapp–Hartung confidence intervals include zero across all strata, evidence does not demonstrate a statistically significant 24-hour opioid-sparing effect.",
      teasStratum: "In the double-blind sham-controlled TEAS stratum (k = 4 strict trials: Chen 1998, Chen 2020, He 2026, Szmit 2021; N = 337), opioid sparing averaged 14.00 mg IV MME (Knapp–Hartung 95% CI [−34.18, +6.19], p = 0.1145, tau2 = 156.88, I2 = 98.59%). High between-study heterogeneity reflects differing surgical baseline pain and anesthesia protocols.",
      eaStratum: "In the needle electroacupuncture stratum (k = 3 strict trials: El-Rakshy 2009, Seevaunnamtum 2016, Yang 2024; N = 339), opioid sparing averaged 3.94 mg IV MME (Knapp–Hartung 95% CI [−19.77, +11.90], p = 0.397, tau2 = 28.47, I2 = 77.15%). With only 3 contributing trials, a dedicated leave-one-out analysis for this stratum is not reported separately; see the primary 24-h opioid leave-one-out table (k = 7) for trial-level influence on the overall pooled estimate.",
  ...
  sv: {
    ...
    kpi: {
      ...
      primaryTitle: "Primär effektanalys • Kompletterande EA-underlag",
      primaryValue: "TEAS: −14,00 mg • EA: −3,94 mg",
      primarySub: "Kompletterande kombinerad syntes: −9,91 mg [−20,08; +0,27] (p=0,0545, k=7)",
      primaryBadge: "PRIMÄR: TEAS jämfört med sham • EA jämfört med sedvanlig vård är kompletterande, inte en primär sham-kontrollerad jämförelse • Kombinerad = endast kontextuell",
    ...
    primarySection: {
      ...
      hubText: "Låst protokollstandard för syntes: TEAS och EA utvärderades separat som de primära modalitetsspecifika analyserna (TEAS mot sham: MD = −14,00 mg, p = 0,1145; EA mot sedvanlig vård: MD = −3,94 mg, p = 0,397). En kombinerad syntes av båda modaliteterna (MD = −9,91 mg [−20,08; +0,27], p = 0,0545, k = 7, N = 676) visas som en kompletterande kontextuell analys. Varians mellan studier estimeras med Restricted Maximum Likelihood (REML) med Knapp–Hartung-konfidensintervall och 95 % prediktionsintervall [−39,35; +19,54].",
      section2ATitle: "Sektion 2A: PRIMÄRT OPIOIDUTFALL — Kumulativ 0–24h opioidbesparing (Strikt modalitetsprimär: TEAS k=4, EA k=3; Kombinerad k=7)",
      ...
      section2BSub: "Beräknad i StataNow 19.5 BE via meta summarize, random(reml) se(kh) predinterval.",
      section2CTitle: "EXPLORATIVT UTÖKAT POSTOPERATIVT OPIOIDUTFALL — Kumulativ 0–72h opioidbesparing (Target B: k = 1 strikt, k = 2 utvidgad)",
      section2CSub: "Beräknad i StataNow 19.5 BE. Utvärderat som hypotesgenererande utökad duration.",
      ...
      combinedPool: "Kompletterande kombinerad syntes (k=7, N=676)",
      teasStratum: "Primärt stratum 1: TEAS mot sham (k=4, N=337)",
      eaStratum: "Primärt stratum 2: EA mot sedvanlig vård (k=3, N=339)",
      threshold10mgNotice: "Primär förspecificerad referenspunkt för klinisk betydelse: 10 mg IV MME. Det sammanvägda genomsnittet (−9,91 mg, 95 % KH KI [−20,08; +0,27]) når inte referenspunkten som punktestimat och når inte statistisk signifikans, även om enskilda patientgrupper med högt basalt opioidbehov uppnår betydande besparing.",
    ...
    metaregStudio: {
      ...
      tableTitle: "Övergripande moderator- och parameteröversikt (k = 7 strikta primära RCT:er)",
    ...
    interpretations: {
      primary24h: "Över de 7 strikta primära studierna (N = 676) visade den kombinerade syntesen av perioperativ elektrisk akupunkturstimulering en estimerad 24-timmars postoperativ opioidminskning på 9,91 mg IV morfinekvivalenter (95 % KH KI [−20,08; +0,27] mg, p = 0,0545, tau2 = 113,91, I2 = 98,57 %; 95 % PI [−39,35; +19,54]). Modalitetsspecifika analyser: TEAS mot sham (k = 4, N = 337) visade MD = −14,00 mg (95 % KH KI [−34,18; +6,19], p = 0,1145), och EA mot kontroll (k = 3, N = 339) visade MD = −3,94 mg (95 % KH KI [−19,77; +11,90], p = 0,397). Eftersom Knapp–Hartung-konfidensintervallen omfattar noll över samtliga strata påvisar evidensen ingen statistiskt signifikant 24-timmars opioidbesparing.",
      teasStratum: "Inom det dubbelblinda sham-kontrollerade TEAS-stratumet (k = 4 strikta studier: Chen 1998, Chen 2020, He 2026, Szmit 2021; N = 337) var den genomsnittliga opioidbesparingen 14,00 mg IV MME (Knapp–Hartung 95 % KI [−34,18; +6,19], p = 0,1145, tau2 = 156,88, I2 = 98,59 %). Hög heterogenitet mellan studier speglar variation i basalt postoperativt smärtbehov och anestesiprotokoll.",
      eaStratum: "Inom nålelektroakupunkturstratumet (k = 3 strikta studier: El-Rakshy 2009, Seevaunnamtum 2016, Yang 2024; N = 339) var den genomsnittliga besparingen 3,94 mg IV MME (Knapp–Hartung 95 % KI [−19,77; +11,90], p = 0,397, tau2 = 28,47, I2 = 77,15 %). Med endast 3 bidragande studier redovisas ingen separat leave-one-out-analys för detta stratum; se leave-one-out-tabellen för det primära 24-timmarsutfallet (k = 7) för studienivåns påverkan på den samlade poolade skattningen.",
...
const STAT_GLOSSARY = {
  en: {
    meanDifference: {
      ...
      context: "For postoperative opioid consumption, negative values indicate lower opioid use in the TEAS/EA group. For example, an MD of −9.91 mg IV MME means patients receiving neuromodulation required on average 9.91 mg less intravenous morphine than control patients.",
      jumpTab: "primary"
    },
    ivMme: {
    ...
    knappHartung: {
      ...
      category: "Statistical Inference",
      shortDef: "An adjustment to the standard errors and confidence intervals in random-effects meta-analysis that accounts for uncertainty in the estimated between-study variance.",
      context: "Uses a t-distribution rather than a normal distribution. Yields wider, more realistic confidence intervals that control the false-positive rate when the number of trials is small.",
      jumpTab: "primary"
    },
    tauSquared: {
      term: "Tau-Squared (τ²)",
      category: "Heterogeneity Measures",
      shortDef: "The estimated variance of true effect sizes across studies in a random-effects meta-analysis.",
      context: "Expressed in squared outcome units (e.g. (mg IV MME)²). A τ² of 0 indicates that all between-study differences are consistent with sampling error alone.",
      jumpTab: "primary"
    },
    iSquared: {
      term: "I-Squared (I²)",
      category: "Heterogeneity Measures",
      shortDef: "The percentage of total variation across studies that is due to true heterogeneity rather than sampling error (chance).",
      context: "Ranges from 0% to 100%. Rough guide: 0–40% might not be important; 30–60% moderate; 50–90% substantial; 75–100% considerable heterogeneity. High I² in perioperative anesthesia reflects genuine differences in surgical trauma and analgesic regimens.",
      jumpTab: "primary"
    },
    predictionInterval: {
      term: "95% Prediction Interval (95% PI)",
      category: "Statistical Inference",
      shortDef: "The estimated range within which the true treatment effect in an individual new study or future clinical setting is expected to fall.",
      context: "Crucial for clinicians: while the 95% CI tells where the average effect lies, the PI tells what might happen to a patient in a new trial or hospital. If the PI includes positive values, some clinical settings may see no benefit.",
      jumpTab: "primary"
    },
    qStatistic: {
      term: "Cochran's Q",
      category: "Heterogeneity Measures",
      shortDef: "A chi-squared test statistic evaluating whether observed differences between study results exceed what would be expected by sampling error alone.",
  ...
  sv: {
    meanDifference: {
      ...
      context: "För postoperativ opioidkonsumtion anger negativa värden lägre opioidförbrukning i TEAS/EA-gruppen. Exempelvis betyder en MD på −9,91 mg IV MME att patienter som fick neuromodulering i genomsnitt använde 9,91 mg mindre intravenöst morfin än kontrollpatienter.",
      jumpTab: "primary"
    },
    ivMme: {
    ...
    nParticipants: {
      ...
      context: "Över alla 70 inkluderade RCT:er pågår avstämning av det totala antalet patienter efter tillägget av 7 studier efter låsningen (inklusive en studie med 1 655 patienter) och är inte omverifierat i denna omgång. För den strikta primära 24h opioidsyntesen är N = 676 patienter.",
      jumpTab: "explorer"
    },
    randomEffects: {
    ...
    knappHartung: {
      ...
      context: "Hartung–Knapp tar hänsyn till ytterligare osäkerhet vid metaanalys med random effects och kan ge mer adekvata konfidensintervall när antalet studier är begränsat eller heterogeniteten mellan studier är påtaglig.",
      jumpTab: "primary"
    },
    predictionInterval: {
    ...
    riskRatio: {
      ...
      context: "Används för dikotoma postoperativa komplikationer som postoperativt illamående och kräkning (PONV). En RR på 0,56 innebär en 44 % relativ riskreduktion. Den absoluta nyttan beror starkt på kontrollgruppens basala incidens.",
      jumpTab: "secondary"
    },
    clinicalThreshold: {
