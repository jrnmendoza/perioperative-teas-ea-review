...
const TRANSLATIONS = {
  en: {
    ...
    primarySection: {
      ...
      section2ATitle: "PRIMARY 24-H OPIOID OUTCOME — Modality-Specific Analyses & Supporting Combined Synthesis",
  ...
  sv: {
    ...
    primarySection: {
      ...
      section2ATitle: "PRIMÄRT 24-H OPIOIDUTFALL — Modalitetsspecifika analyser & stödjande kombinerad syntes",
